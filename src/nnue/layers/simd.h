    ...
    acc = _mm512_add_epi32(
      acc, _mm512_add_epi32(
             __builtin_shufflevector(
               _mm256_madd_epi16(_mm256_maddubs_epi16(__builtin_shufflevector(a0, a0, 0, 1, 2, 3),
                                                      __builtin_shufflevector(b0, b0, 0, 1, 2, 3)),
                                 _mm256_set1_epi16(1)),
               _mm256_madd_epi16(_mm256_maddubs_epi16(__builtin_shufflevector(a0, a0, 4, 5, 6, 7),
                                                      __builtin_shufflevector(b0, b0, 4, 5, 6, 7)),
                                 _mm256_set1_epi16(1)),
               0, 1, 2, 3, 4, 5, 6, 7),
             __builtin_shufflevector(
               _mm256_madd_epi16(_mm256_maddubs_epi16(__builtin_shufflevector(a1, a1, 0, 1, 2, 3),
                                                      __builtin_shufflevector(b1, b1, 0, 1, 2, 3)),
                                 _mm256_set1_epi16(1)),
               _mm256_madd_epi16(_mm256_maddubs_epi16(__builtin_shufflevector(a1, a1, 4, 5, 6, 7),
