...
class HalfKAv2_hm {
    ...
    static constexpr IndexType DarkRestIndex[COLOR_NB][PIECE_NB] = {
      ...
      // Viewed from other side, W and B are reversed
      // clang-format off
      { PS_NONE, PS_DARK + 36, PS_DARK + 37, PS_DARK + 38, PS_DARK + 39, PS_DARK + 40, PS_DARK + 41, PS_NONE,
        PS_NONE, PS_DARK + 42, PS_DARK + 43, PS_DARK + 44, PS_DARK + 45, PS_DARK + 46, PS_DARK + 47, PS_NONE, },
      { PS_NONE, PS_DARK + 42, PS_DARK + 43, PS_DARK + 44, PS_DARK + 45, PS_DARK + 46, PS_DARK + 47, PS_NONE,
        PS_NONE, PS_DARK + 36, PS_DARK + 37, PS_DARK + 38, PS_DARK + 39, PS_DARK + 40, PS_DARK + 41, PS_NONE, }
      // clang-format on
    };
