        ...
        else
        {
            for (IndexType i = 0; i < HalfDimensions / Tiling::TileHeight; ++i)
            {
                ...
                auto* accTileIn = reinterpret_cast<const vec_t*>(
                  &computed->accumulator.accumulation[Perspective][i * Tiling::TileHeight]);
                ...
                auto* accTileOut = reinterpret_cast<vec_t*>(
                  &next->accumulator.accumulation[Perspective][i * Tiling::TileHeight]);
                for (IndexType j = 0; j < Tiling::NumRegs; ++j)
            ...
            for (IndexType i = 0; i < PSQTBuckets / Tiling::PsqtTileHeight; ++i)
            {
                ...
                auto* accTilePsqtIn = reinterpret_cast<const psqt_vec_t*>(
                  &computed->accumulator.psqtAccumulation[Perspective][i * Tiling::PsqtTileHeight]);
                ...
                auto* accTilePsqtOut = reinterpret_cast<psqt_vec_t*>(
                  &next->accumulator.psqtAccumulation[Perspective][i * Tiling::PsqtTileHeight]);
                for (std::size_t j = 0; j < Tiling::NumPsqtRegs; ++j)
